// ─────────────────────────────────────────────────────────────────────────────
// colombiaData.ts — Catálogos oficiales para la Valoración Individual
//   - EPS: Entidades Promotoras de Salud activas en Colombia (+ régimen especial)
//   - Geografía: departamentos y municipios según la división DANE
// Datos de referencia estáticos; se usan para poblar los <select> del formulario.
// ─────────────────────────────────────────────────────────────────────────────

// EPS activas + regímenes especiales/excepción + opción de escape.
export const EPS_COLOMBIA: string[] = [
  'Nueva EPS',
  'EPS Sura',
  'EPS Sanitas',
  'Salud Total EPS',
  ...
  'Régimen Especial — Policía Nacional',
  'Régimen Especial — Ecopetrol',
  'Régimen Especial — Magisterio (FOMAG)',
  'Régimen Especial — Universidades públicas',
  'No asegurado / Particular',
  'Otra',
];

// Departamentos (incluye Bogotá D.C.) y sus municipios según división DANE.
export const COLOMBIA_DEPARTAMENTOS: Record<string, string[]> = {
  'Amazonas': [
  ...
  'Antioquia': [
    ...
    'Angostura', 'Anorí', 'Santafé de Antioquia', 'Anzá', 'Apartadó', 'Arboletes', 'Argelia',
    ...
    'Carepa', 'El Carmen de Viboral', 'Carolina', 'Caucasia', 'Chigorodó', 'Cisneros', 'Cocorná',
    'Concepción', 'Concordia', 'Copacabana', 'Dabeiba', 'Donmatías', 'Ebéjico', 'El Bagre', 'Entrerríos',
    'Envigado', 'Fredonia', 'Frontino', 'Giraldo', 'Girardota', 'Gómez Plata', 'Granada', 'Guadalupe',
    'Guarne', 'Guatapé', 'Heliconia', 'Hispania', 'Itagüí', 'Ituango', 'Jardín', 'Jericó', 'La Ceja',
    ...
    'San Roque', 'San Vicente Ferrer', 'Santa Bárbara', 'Santa Rosa de Osos', 'Santo Domingo',
    'El Santuario', 'Segovia', 'Sonsón', 'Sopetrán', 'Támesis', 'Taraza', 'Tarso', 'Titiribí', 'Toledo',
  ...
  'Bolívar': [
    ...
    'Calamar', 'Cantagallo', 'Cicuco', 'Córdoba', 'Clemencia', 'El Carmen de Bolívar', 'El Guamo',
    'El Peñón', 'Hatillo de Loba', 'Magangué', 'Mahates', 'Margarita', 'María la Baja', 'Montecristo',
    'Mompós', 'Morales', 'Norosí', 'Pinillos', 'Regidor', 'Río Viejo', 'San Cristóbal', 'San Estanislao',
  ...
  'Boyacá': [
    'Tunja', 'Almeida', 'Aquitania', 'Arcabuco', 'Berbeo', 'Betéitiva', 'Boavita', 'Boyacá', 'Briceño',
    'Buenavista', 'Busbanzá', 'Caldas', 'Campohermoso', 'Cerinza', 'Chinavita', 'Chiquinquirá', 'Chíquiza',
    'Chiscas', 'Chita', 'Chitaraque', 'Chivatá', 'Ciénega', 'Cómbita', 'Coper', 'Corrales', 'Covarachía',
    'Cubará', 'Cucaita', 'Cuítiva', 'Chivor', 'Duitama', 'El Cocuy', 'El Espino', 'Firavitoba', 'Floresta',
    'Gachantivá', 'Gámeza', 'Garagoa', 'Guacamayas', 'Guateque', 'Guayatá', 'Güicán de la Sierra', 'Iza',
    'Jenesano', 'Jericó', 'Labranzagrande', 'La Capilla', 'La Victoria', 'La Uvita', 'Villa de Leyva',
    'Macanal', 'Maripí', 'Miraflores', 'Mongua', 'Monguí', 'Moniquirá', 'Motavita', 'Muzo', 'Nobsa',
    'Nuevo Colón', 'Oicatá', 'Otanche', 'Pachavita', 'Páez', 'Paipa', 'Pajarito', 'Panqueba', 'Pauna',
    'Paya', 'Paz de Río', 'Pesca', 'Pisba', 'Puerto Boyacá', 'Quípama', 'Ramiriquí', 'Ráquira', 'Rondón',
    ...
    'Santa Sofía', 'Sativanorte', 'Sativasur', 'Siachoque', 'Soatá', 'Socotá', 'Socha', 'Sogamoso',
    'Somondoco', 'Sora', 'Sotaquirá', 'Soracá', 'Susacón', 'Sutamarchán', 'Sutatenza', 'Tasco', 'Tenza',
  ...
  'Cauca': [
    ...
    'López de Micay', 'Mercaderes', 'Miranda', 'Morales', 'Padilla', 'Páez (Belalcázar)', 'Patía (El Bordo)',
    'Piamonte', 'Piendamó-Tunía', 'Puerto Tejada', 'Puracé (Coconuco)', 'Rosas', 'San Sebastián',
    'Santander de Quilichao', 'Santa Rosa', 'Silvia', 'Sotará (Paispamba)', 'Suárez', 'Sucre', 'Timbío',
  ...
  'Cesar': [
    ...
    'Manaure Balcón del Cesar', 'Pailitas', 'Pelaya', 'Pueblo Bello', 'La Paz (Robles)', 'Río de Oro',
    'San Alberto', 'San Diego', 'San Martín', 'Tamalameque',
  ],
  'Chocó': [
    'Quibdó', 'Acandí', 'Alto Baudó (Pie de Pató)', 'Atrato', 'Bagadó', 'Bahía Solano', 'Bajo Baudó (Pizarro)',
    'Bojayá (Bellavista)', 'El Cantón del San Pablo', 'Carmen del Darién', 'Cértegui', 'Condoto',
    'El Carmen de Atrato', 'El Litoral del San Juan', 'Istmina', 'Juradó', 'Lloró', 'Medio Atrato',
    'Medio Baudó', 'Medio San Juan', 'Nóvita', 'Nuquí', 'Río Iró', 'Río Quito', 'Riosucio', 'San José del Palmar',
  ...
  'Cundinamarca': [
    ...
    'Cachipay', 'Cajicá', 'Caparrapí', 'Cáqueza', 'Carmen de Carupa', 'Chaguaní', 'Chía', 'Chipaque',
    ...
    'Lenguazaque', 'Machetá', 'Madrid', 'Manta', 'Medina', 'Mosquera', 'Nariño', 'Nemocón', 'Nilo', 'Nimaima',
    'Nocaima', 'Venecia', 'Pacho', 'Paime', 'Pandi', 'Paratebueno', 'Pasca', 'Puerto Salgar', 'Pulí', 'Quebradanegra',
    'Quetame', 'Quipile', 'Apulo', 'Ricaurte', 'San Antonio del Tequendama', 'San Bernardo', 'San Cayetano',
    'San Francisco', 'San Juan de Rioseco', 'Sasaima', 'Sesquilé', 'Sibaté', 'Silvania', 'Simijaca', 'Soacha',
    'Sopó', 'Subachoque', 'Suesca', 'Supatá', 'Susa', 'Sutatausa', 'Tabio', 'Tausa', 'Tena', 'Tenjo', 'Tibacuy',
  ...
  'Guainía': [
    'Inírida', 'Barranco Minas', 'Mapiripana', 'San Felipe', 'Puerto Colombia', 'La Guadalupe', 'Cacahual',
    'Pana Pana', 'Morichal',
  ],
  'Guaviare': [
  ...
  'Huila': [
    ...
    'Elías', 'Garzón', 'Gigante', 'Guadalupe', 'Hobo', 'Íquira', 'Isnos', 'La Argentina', 'La Plata', 'Nátaga',
    'Oporapa', 'Paicol', 'Palermo', 'Palestina', 'Pital', 'Pitalito', 'Rivera', 'Saladoblanco', 'San Agustín',
    'Santa María', 'Suaza', 'Tarqui', 'Tesalia', 'Tello', 'Teruel', 'Timaná', 'Villavieja', 'Yaguará',
  ],
  'La Guajira': [
  ...
  'Magdalena': [
    'Santa Marta', 'Algarrobo', 'Aracataca', 'Ariguaní (El Difícil)', 'Cerro de San Antonio', 'Chivolo',
    'Ciénaga', 'Concordia', 'El Banco', 'El Piñón', 'El Retén', 'Fundación', 'Guamal', 'Nueva Granada',
    'Pedraza', 'Pijiño del Carmen', 'Pivijay', 'Plato', 'Puebloviejo', 'Remolino', 'Sabanas de San Ángel',
    'Salamina', 'San Sebastián de Buenavista', 'San Zenón', 'Santa Ana', 'Santa Bárbara de Pinto', 'Sitionuevo',
  ...
  'Nariño': [
    'Pasto', 'Albán (San José)', 'Aldana', 'Ancuyá', 'Arboleda (Berruecos)', 'Barbacoas', 'Belén', 'Buesaco',
    'Colón (Génova)', 'Consacá', 'Contadero', 'Córdoba', 'Cuaspud (Carlosama)', 'Cumbal', 'Cumbitara', 'Chachagüí',
    ...
    'Leiva', 'Linares', 'Los Andes (Sotomayor)', 'Magüí (Payán)', 'Mallama (Piedrancha)', 'Mosquera', 'Nariño',
    'Olaya Herrera', 'Ospina', 'Francisco Pizarro', 'Policarpa', 'Potosí', 'Providencia', 'Puerres', 'Pupiales',
    'Ricaurte', 'Roberto Payán', 'Samaniego', 'Sandoná', 'San Bernardo', 'San Lorenzo', 'San Pablo',
    'San Pedro de Cartago', 'Santa Bárbara (Iscuandé)', 'Santacruz (Guachavés)', 'Sapuyes', 'Taminango', 'Tangua',
    'San Andrés de Tumaco', 'Túquerres', 'Yacuanquer',
  ],
  'Norte de Santander': [
    'Cúcuta', 'Ábrego', 'Arboledas', 'Bochalema', 'Bucarasica', 'Cácota', 'Cachirá', 'Chinácota', 'Chitagá',
  ...
  'Putumayo': [
    ...
    'San Francisco', 'San Miguel', 'Santiago', 'Valle del Guamuez (La Hormiga)', 'Villagarzón',
  ],
  'Quindío': [
  ...
  'Santander': [
    ...
    'Hato', 'Jesús María', 'Jordán', 'La Belleza', 'Landázuri', 'La Paz', 'Lebrija', 'Los Santos', 'Macaravita',
  ...
  'Sucre': [
    'Sincelejo', 'Buenavista', 'Caimito', 'Coloso', 'Corozal', 'Coveñas', 'Chalán', 'El Roble', 'Galeras',
...
// Departamentos ordenados alfabéticamente para el <select>.
export const DEPARTAMENTOS_ORDENADOS = Object.keys(COLOMBIA_DEPARTAMENTOS).sort((a, b) =>
